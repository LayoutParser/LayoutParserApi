...
- [gh CLI desapareceu 2026-08-16](gh-cli-desapareceu-2026-08-16.md) — gh sumiu do PATH/instalação e não há credencial GitHub em cache; push HTTPS trava sem workaround disponível; escalar ao usuário, não forçar.
