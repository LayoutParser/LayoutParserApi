...
- [candidates:[] pra LAY_CNHI_ENVNFE — cap.3: ProjectId/PackageGuid refutados, exceção SQL virava Applicable=false](execute-candidates-ausencia-total-para-cnhi-envnfe.md) — fix aplicado: `GetMappersByLayoutGuidForPackagesAsync` agora relança em vez de engolir; distingue "SQL falhou" de "0 mappers" na resposta do endpoint.
